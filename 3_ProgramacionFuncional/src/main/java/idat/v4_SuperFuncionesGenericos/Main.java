...
public class Main {
    ...
    public Main(){
        ...
        List<Integer> tranformados = SuperFunciones.transformar(filtrados , new OperadorUnario<>(){
            @Override
        ...
        /*Multiplicar Lista */
        Integer reducir = SuperFunciones.reducir(tranformados, 1, new OperadorBinario<>(){
            @Override
